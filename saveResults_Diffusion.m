function saveResults_Diffusion(u_generic, u_quantum, E_class, E_quant, d, flagUtrue, ground_truth)
    if nargin < 7
        ground_truth = [];
    end
